...
var SimpleWebSocket = class _SimpleWebSocket extends import_events.default {
  _socket;
  ...
  static fromAddress(address, options, protocols) {
    return new _SimpleWebSocket(address, options, protocols);
  }
  static fromWsSocket(socket) {
    return new _SimpleWebSocket(socket);
  }
  static fromWebSocket(socket) {
    return new _SimpleWebSocket(socket);
  }
  static fromReconnecting(socket) {
    return new _SimpleWebSocket(socket);
  }
};
